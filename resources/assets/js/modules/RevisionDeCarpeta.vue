<template>
    <panel name="Revision de carpeta Inf. preliminar" class="panel-primary">
        <grid v-model="data"
            ...
            <tr slot-scope="{row, options, format}">
                <td>
                    <router-link :to="{path:'/RevisionFormulario1',query:$route.query}" class="btn btn-sm btn-outline-secondary">
                        edit
                    </router-link>
                </td>
