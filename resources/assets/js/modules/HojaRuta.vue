    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                procedencias: new ApiArray('/api/empresas?per_page=10000'),
                entidades: new ApiArray('/api/entidad?per_page=10000').loadFromAPI(),
                personas: new ApiArray('/api/persona?per_page=10000').loadFromAPI(),
                cgeInternos: new ApiArray('/api/cge_interno?per_page=10000').loadFromAPI(),
