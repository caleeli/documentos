...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse bg-light" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        @foreach(\App\Menu::whereIsRoot()->whereAuth()->get() as $menu)
                            @if ($menu->route==='#')
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    @foreach(\App\Menu::whereIsChildren($menu->id)->whereAuth()->get() as $submenu)
                    ...
                    <router-link class="btn btn-light my-2 my-sm-0" to="/Seguimiento?estado=Completado"><i class="fas fa-bell"></i> <span class="badge badge-warning">@{{pendientesAprobar}}</span></router-link>
                    @endif
        ...
        <script>
            ...
            window.pendientesAprobar = {{App\Tarea::whereTarEstado('Completado')->whereUserOwner()->count()}};
        </script>
    </body>
</html>
