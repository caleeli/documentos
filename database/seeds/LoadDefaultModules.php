...
class LoadDefaultModules extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('modules')
            ->insert([
                ['parent' => 100, 'name' => 'Registrar', 'icon' => '/images/hoja-de-ruta.svg', 'description' => 'Hoja de ruta externa', 'route' => '/HojaRuta/externa/create'],
                ['parent' => 100, 'name' => 'Busqueda', 'icon' => '/images/busqueda.svg', 'description' => 'Hoja de ruta externa', 'route' => '/HojaRutaBusqueda/externa'],
