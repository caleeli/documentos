...
class CreateHojaRutaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->char('referencia', 250)->nullable()->default(null);
            $table->char('procedencia', 200)->nullable()->default(null);
            $table->char('nro_de_control', 15);
            $table->char('anexo_hojas', 150)->nullable()->default(null);
            $table->char('destinatario', 80)->nullable()->default(null);
